( function() {
	var canvas = document.getElementById( "demo_c5_reflection" ).getElementsByTagName( "canvas" )[0];
	...
	gl.shaderSource( vertexShader, "attribute vec3 position; attribute vec3 color; attribute vec2 texcoord; varying vec2 Texcoord; varying vec3 Color; uniform mat4 model; uniform mat4 view; uniform mat4 proj; uniform vec3 overrideColor; void main() { Color = overrideColor * color; Texcoord = texcoord; gl_Position = proj * view * model * vec4( position, 1.0 ); }" );
	...
	var uniColor = gl.getUniformLocation( shaderProgram, "overrideColor" );
	...
	registerAnimatedCanvas( canvas, function( time )
	{
		...
		gl.enable( gl.STENCIL_TEST );
			...
			gl.uniform3f( uniColor, 0.3, 0.3, 0.3 );
				gl.drawArrays( gl.TRIANGLES, 0, 36 );
			gl.uniform3f( uniColor, 1.0, 1.0, 1.0 );
